...
window.onload = function displayWatchlist(){
    ...
    for(let i = 0; i < toWatch.length; i++){
        axios.get("https://api.themoviedb.org/3/movie/"+toWatch[i]+'?api_key='+API_KEY+'&language=pt-BR')
        .then((response)=>{
    ...
    for(let i = 0; i < toWatchTvShows.length; i++){
        axios.get("https://api.themoviedb.org/3/tv/"+toWatchTvShows[i]+'?api_key='+API_KEY+'&language=pt-BR')
            .then((response)=>{
...
function recommendMovies(){
    ...
    axios.get("https://api.themoviedb.org/3/discover/movie?api_key="+API_KEY+'&language=pt-BR&sort_by=popularity.desc&include_adult=false&include_video=false&page='+recommendedPage+'&primary_release_year='+recommendedYear)
        .then((response)=>{
...
function recommendTvShows(){
    ...
    axios.get("https://api.themoviedb.org/3/discover/tv?api_key="+API_KEY+'&language=pt-BR&sort_by=popularity.desc&first_air_date_year='+recommendedYear+'&page='+recommendedPage+'&include_null_first_air_dates=false')
        .then((response)=>{
            console.log(response)
