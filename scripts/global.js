...
function getRandomMovie(){
	...
	axios.get("https://api.themoviedb.org/3/movie/top_rated?api_key="+API_KEY+'&language=pt-BR&page='+randomPage)
		.then( (response) =>{
...
function getRandomTvShow(){
	...
	maxResult = Math.floor(maxResult);
	let randomResult = Math.floor(Math.random() * (maxResult - minResult +1)) + minResult;
	axios.get("https://api.themoviedb.org/3/tv/top_rated?api_key="+API_KEY+'&language=pt-BR&page='+randomPage)
		.then((response)=>{
