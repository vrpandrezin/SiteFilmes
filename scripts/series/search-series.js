...
function genres(id){
    ...
    //API request.
    axios.get("https://api.themoviedb.org/3/discover/tv?api_key="+API_KEY+'&language=pt-BR&sort_by=popularity.desc&page=1&timezone=America%2FNew_York&with_genres='+id+'&include_null_first_air_dates=false')
        .then((response)=>{
...
function showByTitle(input){
    ...
    axios.get("https://api.themoviedb.org/3/search/tv?query="+input+'&api_key='+API_KEY+'&language=pt-BR&page='+pageNum)
        .then((response)=>{
            let series = response.data.results;
            let output = "";
            for(let i = 0; i < series.length; i++){
...
function showsByYear(year){
    ...
    axios.get("https://api.themoviedb.org/3/discover/tv?api_key="+API_KEY+'&language=pt-BR&sort_by=popularity.desc&first_air_date_year='+year+'&page=1&include_null_first_air_dates=false')
        .then((response)=>{
            let series = response.data.results;
            let output = "";
            for(let i = 0; i < series.length; i++){
            ...
            selectedGenres.addEventListener("change", (e)=>{
                ...
                axios.get("https://api.themoviedb.org/3/discover/tv?api_key="+API_KEY+'&language=pt-BR&sort_by=popularity.desc&first_air_date_year='+year+'&page=1&include_null_first_air_dates=false&with_genres='+selectedGenre)
                    .then((response)=>{
                        let series = response.data.results;
                        let output = "";
                        for(let i = 0; i < series.length; i++){
...
function showsByGenrePage(pageNum){
    ...
    //API request.
    axios.get("https://api.themoviedb.org/3/discover/tv?api_key="+API_KEY+'&language=pt-BR&sort_by=popularity.desc&page='+pageNum+'&timezone=America%2FNew_York&with_genres='+id+'&include_null_first_air_dates=false')
        .then((response)=>{
            let series = response.data.results;
            let output = "";
            for(let i = 0; i < series.length; i++){
...
function showsByTitlePage(pageNum){
    ...
    axios.get("https://api.themoviedb.org/3/search/tv?query="+title+'&api_key='+API_KEY+'&language=pt-BR&page='+pageNum)
        .then((response)=>{
            let series = response.data.results;
            let output = "";
            for(let i = 0; i < series.length; i++){
...
function showsByYearPage(pageNum){
    ...
    axios.get("https://api.themoviedb.org/3/discover/tv?api_key="+API_KEY+'&language=pt-BR&sort_by=popularity.desc&first_air_date_year='+year+'&page='+pageNum+'&include_null_first_air_dates=false&with_genres='+genre)
        .then((response)=>{
            let series = response.data.results;
            let output = "";
            for(let i = 0; i < series.length; i++){
