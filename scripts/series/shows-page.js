...
function getShowInfo(){
	...
	const seriesPromise = axios.get("https://api.themoviedb.org/3/tv/"+showId+'?api_key='+API_KEY+'&language=pt-BR');
	const imdbPromise = axios.get("https://api.themoviedb.org/3/tv/"+showId+'/external_ids?api_key='+API_KEY+'&language=pt-BR');
	const seriesCast = axios.get("https://api.themoviedb.org/3/tv/"+showId+'/credits?api_key='+API_KEY+'&language=pt-BR')
	...
	Promise.all([seriesPromise, imdbPromise, seriesCast])
		...
		axios.get("https://api.themoviedb.org/3/tv/"+showId+'/videos?api_key='+API_KEY+'&language=pt-BR')
			.then ((response)=>{
		...
		axios.get("https://api.themoviedb.org/3/tv/"+showId+'/recommendations?api_key='+API_KEY+'&language=pt-BR&page=1')
			.then ((response)=>{
...
function recommendedPage(pageNum){
	...
	axios.get("https://api.themoviedb.org/3/tv/"+showId+'/recommendations?api_key='+API_KEY+'&language=pt-BR&page='+pageNum)
			.then ((response)=>{
				let series = response.data.results;
				series.length = 5;
				let output = "";
