...
window.onload = function featuredMovies(){
    ...
    // POPULAR MOVIES.
    axios.get("https://api.themoviedb.org/3/discover/movie?api_key="+API_KEY+'&language=pt-BR&sort_by=popularity.desc&include_adult=false&include_video=false&page='+popular+'&primary_release_date.gte=2017-12-01&primary_release_date.lte='+today+'&vote_average.gte=6&vote_average.lte=10&with_original_language=pt')
        .then((response)=>{
        ...
        // POPULAR TV SHOWS.
        axios.get("https://api.themoviedb.org/3/tv/popular?api_key="+API_KEY+'&language=pt-BR&page='+popular)
            .then((response)=>{
        ...
        // NOW PLAYING MOVIES
        axios.get("https://api.themoviedb.org/3/movie/now_playing?api_key="+API_KEY+'&language=pt-BR&page=1&region=US')
            .then((response)=>{
