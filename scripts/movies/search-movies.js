...
function searchMovies(searchText){
	...
	axios.get("https://api.themoviedb.org/3/search/movie?query="+searchText+'&api_key='+API_KEY+'&language=pt-BR&page='+pageNum+'&include_adult=false')
		.then( (response) =>{
...
function discoverByActor(actor){
    return axios.get("https://api.themoviedb.org/3/search/person?api_key="+API_KEY+'&language=pt-BR&query='+actor+'&page=1&include_adult=false')
        .then((response)=>{
...
function moviesByActor(){
    ...
    axios.get("https://api.themoviedb.org/3/discover/movie?api_key="+API_KEY+'&language=pt-BR&sort_by=popularity.desc&include_adult=false&include_video=false&page=1&with_people='+actorId)
        .then((response)=>{
            let movie = response.data.results;
            let output = "";
            for(let i = 0; i < movie.length; i++){
        ...
        selectedGenres.addEventListener("change", (e)=>{
            ...
            axios.get("https://api.themoviedb.org/3/discover/movie?api_key="+API_KEY+'&language=pt-BR&sort_by=popularity.desc&include_adult=false&include_video=false&page=1&with_people='+actorId+'&with_genres='+selectedGenre)
                .then((response)=>{
                    let movie = response.data.results;
                    let output = "";
                    for(let i = 0; i < movie.length; i++){
...
function discoverMovies(year){
    ...
    axios.get("https://api.themoviedb.org/3/discover/movie?api_key="+API_KEY+'&language=pt-BR&sort_by=popularity.desc&page=1&primary_release_year='+year)
        .then((response)=>{
            let movie = response.data.results;
            let output = "";
            for(let i = 0; i < movie.length; i++){
            ...
            selectedGenres.addEventListener("change", (e)=>{
                ...
                axios.get("https://api.themoviedb.org/3/discover/movie?api_key="+API_KEY+'&language=pt-BR&sort_by=popularity.desc&page=1&primary_release_year='+year+'&with_genres='+selectedGenre)
                .then((response)=>{
                let movie = response.data.results;
                let output = "";
                for(let i = 0; i < movie.length; i++){
...
function genres(id){
        ...
        //API request.
        axios.get("https://api.themoviedb.org/3/discover/movie?api_key="+API_KEY+'&llanguage=pt-BR&sort_by=popularity.desc&include_adult=false&include_video=false&page=1&with_genres='+id)
            .then((response)=>{
                let movie = response.data.results;
                let output = "";
                for(let i = 0; i < movie.length; i++){
...
function movieByActorPage(pageNum){
    ...
    axios.get("https://api.themoviedb.org/3/discover/movie?api_key="+API_KEY+'&language=pt-BR&sort_by=popularity.desc&include_adult=false&include_video=false&page='+pageNum+'&with_people='+actorId+'&with_genres='+genre)
    .then((response) => {
        let movie = response.data.results;
        let output = "";
        for(let i = 0; i < movie.length; i++){
...
function movieByYearPage(pageNum){
    ...
    axios.get('https://api.themoviedb.org/3/discover/movie?api_key='+API_KEY+'&language=pt-BR&sort_by=popularity.desc&page='+pageNum+'&primary_release_year='+year+'&with_genres='+genre)
    .then((response)=>{
        let movie = response.data.results;
        let output = "";
        for(let i = 0; i < movie.length; i++){
...
function movieByGenrePage(pageNum){
        ...
        axios.get("https://api.themoviedb.org/3/discover/movie?api_key="+API_KEY+'&language=pt-BR&sort_by=popularity.desc&include_adult=false&include_video=false&page='+pageNum+'&with_genres='+genre)
            .then((response)=>{
                let movie = response.data.results;
                let output = "";
                for(let i = 0; i < movie.length; i++){
